...
const CodeOfConduct = () => (
  <div className="CodeOfConduct">
    ...
    <p>
      A primary goal of Raha is to be inclusive to the largest number of
    ...
    <p>
      We invite all those who participate in Raha to help us create safe and
      positive experiences for everyone.
    </p>
    <h2 id="open-sourceculturetech-citizenship">2. Raha Citizenship</h2>
    <p>
      A supplemental goal of this Code of Conduct is to increase open Raha
    ...
    <p>
      No weapons will be allowed at Raha events, community spaces, or in other
      spaces covered by the scope of this Code of Conduct. Weapons include but
      are not limited to guns, explosives (including fireworks), and large
      ...
      and will only be allowed to return without the weapon. Community members
      are further expected to comply with all state and local laws on this
      matter.
    </p>
    ...
    <p>
      ...
      Code of Conduct, you should notify help@raha.io with a concise description
    ...
    <p>
      ...
      community venues&#8211;online and in-person&#8211;as well as in all
    ...
    <p>
      ...
      unacceptable behavior occuring outside the scope of community activities
    ...
    <p>
      ...
      <a href="http://citizencodeofconduct.org/">Citizen Code of Conduct</a>,
